...
template : '<div ng-controller="LanguageController">'
            +'<button ng-click="changeLanguage(\'bs\')"><img src="/assets/flag1.png" height="20" width="30"></button>'
            +'<button ng-click="changeLanguage(\'en\')"><img src="/assets/flag2.png" height="20" width="30"></button>'
          +'</div>'  
};
});